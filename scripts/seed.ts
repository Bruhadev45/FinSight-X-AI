...
async function seed() {
  ...
  try {
    ...
    const documents = await db.insert(schema.documents).values([
      ...
      {
        userId: 'user_3',
        companyId: companies[2].id, // Alphabet
      ...
      // Additional documents across various companies
      {
        userId: 'user_1',
        companyId: companies[3].id, // Meta
        fileName: 'Meta_Q2_2024_Earnings.pdf',
        fileType: 'application/pdf',
        fileSize: 3892456,
        ...
        anomalyCount: 5,
        complianceStatus: 'compliant',
        summary: 'Q2 earnings show metaverse losses widening to $4.5B. Ad revenue recovering but privacy changes impacting growth.',
        storagePath: '/uploads/meta_q2_2024.pdf',
        createdAt: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_2',
        companyId: companies[4].id, // NVIDIA
        fileName: 'NVIDIA_Annual_Report_2024.pdf',
        fileType: 'application/pdf',
        fileSize: 5123789,
        ...
        anomalyCount: 1,
        complianceStatus: 'compliant',
        summary: 'Exceptional year driven by AI chip demand. Data center revenue up 217% YoY. Strong profitability across all segments.',
        storagePath: '/uploads/nvidia_annual_2024.pdf',
        createdAt: new Date(Date.now() - 9 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_1',
        companyId: companies[6].id, // Alibaba
        fileName: 'Alibaba_Quarterly_Filing.pdf',
        fileType: 'application/pdf',
        fileSize: 4567123,
        ...
        anomalyCount: 9,
        complianceStatus: 'review_required',
        summary: 'Regulatory pressures in China impacting operations. Revenue decline of 5%. VIE structure concerns raised by auditors.',
        storagePath: '/uploads/alibaba_quarterly.pdf',
        createdAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_3',
        companyId: companies[8].id, // Toyota
        fileName: 'Toyota_Financial_Statement.pdf',
        fileType: 'application/pdf',
        fileSize: 3678912,
        ...
        anomalyCount: 2,
        complianceStatus: 'compliant',
        summary: 'Solid performance across global markets. Hybrid vehicle sales up 32%. EV strategy accelerating with $15B investment.',
        storagePath: '/uploads/toyota_financial.pdf',
        createdAt: new Date(Date.now() - 11 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_2',
        companyId: companies[9].id, // Ford
        fileName: 'Ford_Q3_Results.pdf',
        fileType: 'application/pdf',
        fileSize: 2789456,
        ...
        anomalyCount: 6,
        complianceStatus: 'compliant',
        summary: 'Mixed results with EV division losses of $1.3B. Traditional truck business remains profitable. Inventory concerns.',
        storagePath: '/uploads/ford_q3.pdf',
        createdAt: new Date(Date.now() - 12 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_1',
        companyId: companies[11].id, // Bank of America
        fileName: 'BofA_Risk_Report_2024.pdf',
        fileType: 'application/pdf',
        fileSize: 5234678,
        ...
        anomalyCount: 11,
        complianceStatus: 'review_required',
        summary: 'Commercial real estate exposure at $157B. Net interest margin compression. Credit card delinquencies rising.',
        storagePath: '/uploads/bofa_risk_2024.pdf',
        createdAt: new Date(Date.now() - 13 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_3',
        companyId: companies[12].id, // Goldman Sachs
        fileName: 'Goldman_Sachs_Annual_2024.pdf',
        fileType: 'application/pdf',
        fileSize: 4891234,
        ...
        anomalyCount: 7,
        complianceStatus: 'compliant',
        summary: 'Investment banking revenue down 28%. Trading revenue compensating. Marcus consumer banking unit being wound down.',
        storagePath: '/uploads/goldman_annual_2024.pdf',
        createdAt: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_2',
        companyId: companies[13].id, // Morgan Stanley
        fileName: 'Morgan_Stanley_Q4.pdf',
        fileType: 'application/pdf',
        fileSize: 3456891,
        ...
        anomalyCount: 3,
        complianceStatus: 'compliant',
        summary: 'Strong Q4 with wealth management revenue up 12%. Integration of E-Trade progressing well. Cost discipline maintained.',
        storagePath: '/uploads/morgan_stanley_q4.pdf',
        createdAt: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_1',
        companyId: companies[14].id, // Wells Fargo
        fileName: 'Wells_Fargo_Compliance_Report.pdf',
        fileType: 'application/pdf',
        fileSize: 4123789,
        ...
        anomalyCount: 15,
        complianceStatus: 'non_compliant',
        summary: 'Multiple compliance failures identified. Asset cap still in place. Remediation costs exceeding $500M annually.',
        storagePath: '/uploads/wells_compliance.pdf',
        createdAt: new Date(Date.now() - 16 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_3',
        companyId: companies[15].id, // Johnson & Johnson
        fileName: 'JNJ_Pharmaceutical_Review.pdf',
        fileType: 'application/pdf',
        fileSize: 3789123,
        uploadDate: new Date(Date.now() - 17 * 24 * 60 * 60 * 1000).toISOString(),
        status: 'completed',
        riskLevel: 'low',
        anomalyCount: 2,
        complianceStatus: 'compliant',
        summary: 'Strong pharmaceutical pipeline. Consumer health spinoff completed successfully. Litigation reserves adequate.',
        storagePath: '/uploads/jnj_pharma.pdf',
        createdAt: new Date(Date.now() - 17 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_2',
        companyId: companies[16].id, // Pfizer
        fileName: 'Pfizer_Post_COVID_Analysis.pdf',
        fileType: 'application/pdf',
        fileSize: 4234567,
        ...
        anomalyCount: 5,
        complianceStatus: 'compliant',
        summary: 'COVID revenue declining sharply. Pipeline strength questioned. Cost restructuring program announced.',
        storagePath: '/uploads/pfizer_post_covid.pdf',
        createdAt: new Date(Date.now() - 18 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_1',
        companyId: companies[18].id, // Exxon Mobil
        fileName: 'Exxon_Energy_Outlook.pdf',
        fileType: 'application/pdf',
        fileSize: 5678912,
        uploadDate: new Date(Date.now() - 19 * 24 * 60 * 60 * 1000).toISOString(),
        status: 'completed',
        riskLevel: 'medium',
        anomalyCount: 6,
        complianceStatus: 'compliant',
        summary: 'Record profits on higher oil prices. Carbon transition investments still minimal. Buyback program accelerated.',
        storagePath: '/uploads/exxon_outlook.pdf',
        createdAt: new Date(Date.now() - 19 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_3',
        companyId: companies[19].id, // Chevron
        fileName: 'Chevron_Sustainability_Report.pdf',
        fileType: 'application/pdf',
        fileSize: 3891245,
        ...
        anomalyCount: 3,
        complianceStatus: 'compliant',
        summary: 'Balanced approach to energy transition. LNG investments proceeding. Emissions targets on track.',
        storagePath: '/uploads/chevron_sustainability.pdf',
        createdAt: new Date(Date.now() - 20 * 24 * 60 * 60 * 1000).toISOString(),
      },
      {
        userId: 'user_2',
        companyId: companies[20].id, // P&G
        fileName: 'PG_Consumer_Trends.pdf',
        fileType: 'application/pdf',
        fileSize: 2987456,
        ...
        anomalyCount: 1,
        complianceStatus: 'compliant',
        summary: 'Resilient performance despite inflation. Pricing power demonstrated. Market share gains in key categories.',
        storagePath: '/uploads/pg_consumer.pdf',
